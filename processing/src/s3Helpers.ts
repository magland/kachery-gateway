...
export const putObject = async (bucket: Bucket, params: PutObjectRequest) => {
    return new Promise((resolve, reject) => {
        ...
        request.on('httpHeaders', (statusCode: number, headers: any, response: any, statusMessage: string) => {
            if (statusCode !== 200) {
